...
@section('content')
    @inject('shared', 'App\Http\Controllers\JobsController')
    {{ $shared->jobList() }}
    <br><br>
    <section class="job-bg page job-list-page">
        <div class="container">
            ...
            <div class="breadcrumb-section">
                <h2 class="title">{{ $results->count() }} offre(s) trouvée(s)</h2>
            </div>
                                ...
                                <div class="panel panel-default panel-faq">
                                    ...
                                    <div id="accordion-one" class="panel-collapse collapse in">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <ul>
                                                @foreach($shared->jobList()->$catLists as $catList)
                                                    @if($loop->index < 3)
                                        ...
                                        <div class="panel-body">
                                            @foreach($typelists as $typelist)
                                                <form action="{{ route('jobfiltre', ['id'=>$typelist->id]) }}", method="get">
                                                    <label for="{{ $typelist->name }}"><input type="checkbox" name="{{ $typelist->name }}" id="{{ $typelist->name }}" onclick="this.form.submit()"> {{ $typelist->name }} </label>
                                                </form>
                                            @endforeach
                                        </div><!-- panel-body -->
                                    </div>
