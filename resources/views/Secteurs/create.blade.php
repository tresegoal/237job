...
@section('content')
  ...
  <div class="container">
    <div class="row">
        ...
        <div class="col-md-12 ">
            <a href="{{ route('secteur.index') }}" class="btn btn-success" style="margin-bottom: 30px"> <i class="fa fa-list"></i> Liste des secteurs d'activités</a>
                ...
                <div class="panel-body">
                  <div class="col-sm-12">
                    {!! Form::open(['route' => 'secteur.store', 'class' => 'form-horizontal panel']) !!} 
                      ...
                      <div class="form-group">
                        <div class="checkbox">
                          <label>
                            {!! Form::checkbox('confirmed', 1, null) !!} Activer le secteur
                          </label>
                        </div>
                      </div>
